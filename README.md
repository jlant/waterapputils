...
![Compare WATER output files](docs/_static/gui-watertxtcmp.png "Compare WATER output files")

![Apply water use to WATER output filest](docs/_static/gui-wateruse.png "Apply water use to WATER output files")

![Apply global climate delta factors to WATER database files](docs/_static/gui-gcmdelta.png "Apply global climate delta factors to WATER database files")
