...
def test_read_file_in_data_file1():
    ...
    actual = deltastxt.read_file_in(fileobj)
...
def test_get_monthly_values():
    ...
    actual1 = deltastxt.get_monthly_values(delta_data = fixture["sample_data"], tile_list = ["11", "12"])
    ...
    actual2 = deltastxt.get_monthly_values(delta_data = fixture["sample_data"], tile_list = ["12", "22", "32"])
...
def test_format_to_monthly_dict():
    ...
    actual1 = deltastxt.format_to_monthly_dict(values = fixture["sample_monthly_values1"])
    actual2 = deltastxt.format_to_monthly_dict(values = fixture["sample_monthly_values2"])
...
def test_get_avg_delta_values1():
    ...
    actual = deltastxt.get_avg_delta_values(deltastxt_data = fixture["sample_data"], tile_list = ["11", "12"])
...
def test_get_avg_delta_values2():
    ...
    actual = deltastxt.get_avg_delta_values(deltastxt_data = fixture["sample_data"], tile_list = ["11", "12", "32"])
...
def test_get_avg_delta_values3():
    
    expected = {'PET' : {'January': 1.25, 'February': 2.75, 'March': 3.25, 'April': 4.75, 'May': 5.25, 'June': 6.75, 'July': 7.25, 'August': 8.75, 'September': 9.25, 'October': 10.75, 'November': 11.25, 'December': 12.75}}    
    
    actual = deltastxt.get_avg_delta_values(deltastxt_data = fixture["sample_data_bad"], tile_list = ["11", "12"])
