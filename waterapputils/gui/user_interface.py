...
#
# Created: Fri Feb 13 16:54:06 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab_wateruse_push_button_open_sim = QtGui.QPushButton(self.groupBox_9)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.tab_wateruse_push_button_open_sim.setFont(font)
        self.tab_wateruse_push_button_open_sim.setObjectName(_fromUtf8("tab_wateruse_push_button_open_sim"))
        self.gridLayout_2.addWidget(self.tab_wateruse_push_button_open_sim, 0, 0, 1, 1)
        self.tab_wateruse_push_button_open_sims = QtGui.QPushButton(self.groupBox_9)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.tab_wateruse_push_button_open_sims.setFont(font)
        self.tab_wateruse_push_button_open_sims.setObjectName(_fromUtf8("tab_wateruse_push_button_open_sims"))
        self.gridLayout_2.addWidget(self.tab_wateruse_push_button_open_sims, 1, 0, 1, 1)
        ...
        self.tab_wateruse_sim_info_radio_button = QtGui.QRadioButton(self.groupBox_10)
        self.tab_wateruse_sim_info_radio_button.setChecked(True)
        self.tab_wateruse_sim_info_radio_button.setObjectName(_fromUtf8("tab_wateruse_sim_info_radio_button"))
        self.formLayout_2.setWidget(0, QtGui.QFormLayout.LabelRole, self.tab_wateruse_sim_info_radio_button)
        ...
        self.tab_wateruse_sim_info_basin_shp_id_field = QtGui.QLineEdit(self.groupBox_10)
        self.tab_wateruse_sim_info_basin_shp_id_field.setText(_fromUtf8(""))
        self.tab_wateruse_sim_info_basin_shp_id_field.setObjectName(_fromUtf8("tab_wateruse_sim_info_basin_shp_id_field"))
        self.formLayout_2.setWidget(3, QtGui.QFormLayout.FieldRole, self.tab_wateruse_sim_info_basin_shp_id_field)
        self.label_5 = QtGui.QLabel(self.groupBox_10)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.formLayout_2.setWidget(4, QtGui.QFormLayout.LabelRole, self.label_5)
        self.tab_wateruse_sim_info_basin_shp_area_field = QtGui.QLineEdit(self.groupBox_10)
        self.tab_wateruse_sim_info_basin_shp_area_field.setObjectName(_fromUtf8("tab_wateruse_sim_info_basin_shp_area_field"))
        self.formLayout_2.setWidget(4, QtGui.QFormLayout.FieldRole, self.tab_wateruse_sim_info_basin_shp_area_field)
        self.tab_wateruse_sim_info_basin_shp_name = QtGui.QLineEdit(self.groupBox_10)
        self.tab_wateruse_sim_info_basin_shp_name.setObjectName(_fromUtf8("tab_wateruse_sim_info_basin_shp_name"))
        self.formLayout_2.setWidget(2, QtGui.QFormLayout.FieldRole, self.tab_wateruse_sim_info_basin_shp_name)
        ...
        self.gridLayout_5.addWidget(self.tab_wateruse_line_edit_wateruse_factor_file, 2, 1, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.tab_wateruse_push_button_wateruse_files, 0, 0, 2, 1)
        ...
        self.gridLayout_5.addWidget(self.tab_wateruse_push_button_wateruse_factor_file, 2, 0, 2, 1)
        ...
        self.gridLayout_5.addWidget(self.tab_wateruse_line_edit_wateruse_shp, 4, 1, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.tab_wateruse_push_button_wateruse_shp, 4, 0, 2, 1)
        self.label_6 = QtGui.QLabel(self.groupBox_11)
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.gridLayout_5.addWidget(self.label_6, 6, 0, 1, 1)
        self.tab_wateruse_line_edit_wateruse_id_field = QtGui.QLineEdit(self.groupBox_11)
        self.tab_wateruse_line_edit_wateruse_id_field.setObjectName(_fromUtf8("tab_wateruse_line_edit_wateruse_id_field"))
        self.gridLayout_5.addWidget(self.tab_wateruse_line_edit_wateruse_id_field, 6, 1, 1, 2)
        self.tab_wateruse_line_edit_wateruse_files = QtGui.QLineEdit(self.groupBox_11)
        self.tab_wateruse_line_edit_wateruse_files.setObjectName(_fromUtf8("tab_wateruse_line_edit_wateruse_files"))
        self.gridLayout_5.addWidget(self.tab_wateruse_line_edit_wateruse_files, 0, 1, 2, 2)
        ...
        self.gridLayout_5.addWidget(self.label_2, 2, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_9.setTitle(_translate("MainWindow", "Choose simulation(s)", None))
        self.tab_wateruse_push_button_open_sim.setText(_translate("MainWindow", "Open Directory", None))
        self.tab_wateruse_push_button_open_sims.setText(_translate("MainWindow", "Open Directory", None))
        self.label_7.setText(_translate("MainWindow", "1 simulation", None))
        self.lineEdit_9.setPlaceholderText(_translate("MainWindow", "Directory of many WATER simulations", None))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Directory of a WATER simulation", None))
        self.label_8.setText(_translate("MainWindow", "1+ simulations", None))
        self.groupBox_10.setTitle(_translate("MainWindow", "Simulation information", None))
        self.tab_wateruse_sim_info_radio_button.setText(_translate("MainWindow", "Batch", None))
        self.radioButton_2.setText(_translate("MainWindow", "Single", None))
        ...
        self.tab_wateruse_sim_info_basin_shp_id_field.setPlaceholderText(_translate("MainWindow", "STAID", None))
        self.label_5.setText(_translate("MainWindow", "Basin shapefile area field", None))
        self.tab_wateruse_sim_info_basin_shp_area_field.setPlaceholderText(_translate("MainWindow", "da_sqmi", None))
        self.tab_wateruse_sim_info_basin_shp_name.setPlaceholderText(_translate("MainWindow", "Watersheds.shp", None))
        ...
        self.tab_wateruse_line_edit_wateruse_id_field.setPlaceholderText(_translate("MainWindow", "newhydroid", None))
        self.tab_wateruse_line_edit_wateruse_files.setPlaceholderText(_translate("MainWindow", "Water use data files", None))
        self.label.setText(_translate("MainWindow", "data files", None))
        self.label_2.setText(_translate("MainWindow", "factor file", None))
        self.label_9.setText(_translate("MainWindow", "shapefile", None))
