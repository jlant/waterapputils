...
#
# Created: Wed Mar 11 16:53:25 2015
...
"</html>", None))
        ...
        self.main_tab_widget.setTabText(self.main_tab_widget.indexOf(self.tab_applywateruse), _translate("MainWindow", "Apply water use to WATER simulation(s)", None))
...
"</html>", None))
        ...
        self.tab_gcm_line_edit_gcm_shp.setPlaceholderText(_translate("MainWindow", "Global climate modeshapefile", None))
        self.tab_gcm_push_button_gcm_shp.setToolTip(_translate("MainWindow", "<html><head/><body><p>Open a water use shapefile. </p></body></html>", None))
        self.tab_gcm_push_button_gcm_shp.setText(_translate("MainWindow", "Open file", None))
        self.tab_gcm_push_button_gcm_files.setToolTip(_translate("MainWindow", "Open 4 seasonal water use text files.  ", None))
        ...
        self.tab_gcm_checkbox_subwateruse.setToolTip(_translate("MainWindow", "Check if applying substitute water use.", None))
        self.tab_gcm_checkbox_subwateruse.setText(_translate("MainWindow", "Use substitute global climate model", None))
        self.tab_gcm_push_button_check_inputs.setToolTip(_translate("MainWindow", "<html><head/><body><p>Makes sure all inputs were entered. Enables applying water use button and map plotting buttons.</p></body></html>", None))
        ...
        self.tab_gcm_push_button_apply_gcm.setText(_translate("MainWindow", "Apply Global Climate Model", None))
        ...
        self.main_tab_widget.setTabText(self.main_tab_widget.indexOf(self.tab_applygcm), _translate("MainWindow", "Apply global climate model(s) (GCM) to WATER simulation(s)", None))
